...
class HomeController extends Controller
{
    ...
    {
        $user_post = DB::table('posts')->join('users', 'user_id', '=', 'users.id')->where('user_id', Auth::user()->id)->select('posts.id', 'user_id', 'first_name', 'last_name', 'description', 'posts.created_at');
        ...
        $user_friend_post = DB::table('friends')->join('users as user', 'user.id', '=', 'user_id')
            ...
            ->select('posts.id', 'friend.id as user_id', 'friend.first_name', 'friend.last_name', 'description', 'posts.created_at')
